...
const STRATUM_PANELS: Record<string, PanelConfig> = {
  ...
  'stratum-civilizational': { name: 'Civilizational Analysis', enabled: false, priority: 2 },
  'stratum-critical-alerts': { name: 'Critical Alerts', enabled: true, priority: 1 },
  'stratum-scoring': { name: 'Civilizational Scoring', enabled: true, priority: 1 },
  'stratum-ja-observatory': { name: 'J&A Observatory', enabled: false, priority: 2 },
  'stratum-ai-insights': { name: 'AI Insights', enabled: true, priority: 2 },
  'stratum-chat': { name: 'STRATUM Analysis', enabled: true, priority: 2 },
  'stratum-journal': { name: '📓 Intelligence Journal', enabled: true, priority: 1 },
